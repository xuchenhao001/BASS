...
from utils.util import server_learning_rate_adjust, calculate_server_step
...
def main():
    ...
    for epoch in range(env_store.args.epochs):
        ...
        if env_store.args.sign_sgd:
            ...
            new_w_global = node_summarized_sign_sgd(received_w_locals, w_global, env_store.args.server_lr,
                                                    env_store.args.device)
        else:
            new_w_global = fed_avg(received_w_locals, w_global, env_store.args.device)
