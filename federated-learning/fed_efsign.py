...
def main():
    ...
    for epoch in range(env_store.args.epochs):
        ...
        for trainer in trainer_store:
            ...
            trainer.extract_ef_sign(w_global, d_w_global, env_store.args.device)
        ...
        new_w_global = error_feedback_sign_sgd(received_w_locals, w_global, env_store.args.device)
